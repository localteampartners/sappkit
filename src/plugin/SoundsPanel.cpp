...
const std::vector<LibraryDef>& soundsRegistry()
{
    static const std::vector<LibraryDef> registry{
        ...
        {"muldjord-kit", "Muldjord Kit (Tama rock/metal)", "350 MB", "CC-BY 4.0", "zip",
         {"https://codeload.github.com/sfzinstruments/DrumGizmo.MuldjordKit/zip/refs/heads/master"}},
        {"drs-kit", "DRS Kit (Sonor, DrumGizmo)", "740 MB", "CC-BY 4.0", "zip",
         {"https://codeload.github.com/sfzinstruments/DrumGizmo.DRSKit/zip/refs/heads/master"}},
        {"naked-drums", "Naked Drums (multi-mic, 10 RR)", "1.3 GB", "CC-BY 4.0", "zip",
         {"https://codeload.github.com/sfzinstruments/WilkinsonAudio.NakedDrums/zip/refs/heads/master"}},
        {"virtuosity-drums", "Virtuosity Drums (Versilian)", "1.2 GB", "CC0 public domain", "zip",
         {"https://codeload.github.com/sfzinstruments/virtuosity_drums/zip/refs/heads/master"}},
        {"swirly-drums", "Swirly Drums (brushes, indie)", "840 MB", "CC0 public domain", "zip",
         {"https://codeload.github.com/sfzinstruments/karoryfer.swirly-drums/zip/refs/heads/main"}},
        {"unruly-drums", "Unruly Drums (every drum a snare)", "660 MB", "CC0 public domain", "zip",
         {"https://codeload.github.com/sfzinstruments/karoryfer.unruly-drums/zip/refs/heads/main"}},
        {"frankensnare", "Frankensnare (snare collection)", "340 MB", "CC0 public domain", "zip",
